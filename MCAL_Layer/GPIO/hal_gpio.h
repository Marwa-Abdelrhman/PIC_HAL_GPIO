...
volatile uint8 * tris_reg[]={&TRISA,&TRISB,&TRISC,&TRISD,&TRISE};        /*direction registers to control INPUT/OUTPUT, we can write and read to it*/
volatile uint8 * lat_reg[]={&LATA,&LATB,&LATC,&LATD,&LATE};              /*data registers to R/W*/
