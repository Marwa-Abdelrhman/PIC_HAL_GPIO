...
# 1 "MCAL_Layer/GPIO/../compilers.h" 1
# 11 "MCAL_Layer/GPIO/../compilers.h"
...
# 11 "MCAL_Layer/GPIO/../compilers.h" 2
...
# 21 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
Std_RetrunType gpio_pin_direction_init(const pin_config_t *pin_confg){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
    if(pin_confg == ((void*)0) || (pin_confg->pin > 8 -1))
    {
    ...
    else
    {
        switch(pin_confg->direction)
        {
            case GPIO_DIRECTION_OUTPUT:
                (*tris_reg[pin_confg->port] &=~ ((uint8) 1<<pin_confg->pin));
                break;
            case GPIO_DIRECTION_INPUT:
                (*tris_reg[pin_confg->port] |= ((uint8) 1<<pin_confg->pin));
                break;
            default:ret= ((Std_RetrunType) 0x00);
...
Std_RetrunType gpio_pin_get_direction_status(const pin_config_t *pin_confg,direction_t *pin_dir){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
    if(pin_confg == ((void*)0) ||pin_dir ==((void*)0) ||(pin_confg->pin > 8 -1))
    {
        ret=((Std_RetrunType) 0x00);
    }
    else
    {
        *pin_dir= ((*tris_reg[pin_confg->port]>>pin_confg->pin) & (uint8) 1);
    }
...
Std_RetrunType gpio_pin_write(const pin_config_t *pin_confg,state_t pin_state){
    ...
    else
    {
        ...
        {
            case GPIO_STATE_LOW:
                (*lat_reg[pin_confg->port] &=~ ((uint8) 1<<pin_confg->pin));
                break;
...
# 113 "MCAL_Layer/GPIO/hal_gpio.c"
Std_RetrunType gpio_pin_read(const pin_config_t *pin_confg,state_t *pin_state){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
       if(pin_confg == ((void*)0) ||pin_state ==((void*)0) ||(pin_confg->pin > 8 -1))
    {
        ret=((Std_RetrunType) 0x00);
    }
    else
...
# 225 "MCAL_Layer/GPIO/hal_gpio.c"
Std_RetrunType gpio_port_write(port_t port_confg,uint8 port_state){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
      if(port_confg > 5 -1)
    {
...
# 246 "MCAL_Layer/GPIO/hal_gpio.c"
Std_RetrunType gpio_port_read(port_t port_confg,uint8 *port_state){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
      if(port_confg > 5 -1)
    {
...
# 266 "MCAL_Layer/GPIO/hal_gpio.c"
Std_RetrunType gpio_port_toggle(port_t port_confg){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
      if(port_confg > 5 -1)
    {
